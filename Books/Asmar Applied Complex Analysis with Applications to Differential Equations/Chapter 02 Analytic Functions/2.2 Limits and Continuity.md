...
1. How do limits interact with linear combinations of functions?
2. How do limits interact with products?
3. Why does the quotient law require the extra condition that the denominator limit is nonzero?
4. Under what hypotheses can you pass a limit through a composition $f(g(z))$ ?
5. How can the squeeze theorem be used to prove a function tends to 0 , especially when one factor is bounded?
