...
Manipulate[
 Module[
  ...
  leftPlot =
   Graphics[
    {
     {LightBlue, Opacity[0.5], EdgeForm[{Thick, Blue, Dashed}], Disk[{0, 0}, 1]},
     {Darker[Green], Thick, Arrow[{{0, 0}, zPoint}]},
  ...
  rightPlot =
   Graphics[
    {
     {LightBlue, Opacity[0.5], EdgeForm[{Thick, Blue, Dashed}], Disk[{2, 1}, 1]},
     {Purple, Thick, Arrow[{{0, 0}, translation}]},
     Text[Style["2 + i", 15, Purple], translation + {0.15, 0.12}],
     {Darker[Green], Thick, Arrow[{translation, wPoint}]},
     {Red, PointSize[0.025], Point[wPoint]},
     Text[Style["w", 16, Bold], wPoint + {0.08, 0.08}]
     },
    Axes -> True,
    GridLines -> Automatic,
    PlotRange -> {{-0.8, 3.8}, {-1.3, 3.3}},
    AspectRatio -> 1,
    ImageSize -> 520,
    PlotLabel -> Style["w-plane: f[S]", 18],
    AxesLabel -> {"u", "v"}
    ];
  
  Column[
   {
    Style["Exercise 1: translation under w = z + 2 + i", 22, Bold],
    GraphicsRow[{leftPlot, rightPlot}, Spacings -> 30],
    Style[
     Row[{
       "z = ", NumberForm[Re[z], {3, 2}], " + ", NumberForm[Im[z], {3, 2}], " i",
       "    \[LongRightArrow]    w = ", NumberForm[Re[w], {4, 2}], " + ", NumberForm[Im[w], {4, 2}], " i"
       }],
     15
     ]
    }
 ...
 {{r, 0.7, "r"}, 0, 1, Appearance -> "Labeled"},
 {{\[Theta], Pi/4, "\[Theta]"}, 0, 2 Pi, Appearance -> "Labeled"},
 TrackedSymbols :> {r, \[Theta]}
]
```
...
Manipulate[
 Module[
  ...
  leftPlot =
   Graphics[
    {
     {LightBlue, Opacity[0.5], EdgeForm[{Thick, Blue, Dashed}], Rectangle[{1, -1}, {3, 1}]},
     {GrayLevel[0.45], Dashed, Line[{{x, 0}, zPoint}], Line[{{0, y}, zPoint}]},
     {Darker[Green], Thick, Line[{{2, 0}, zPoint}]},
     {Red, AbsolutePointSize[11], Point[zPoint]},
     Text[
      Framed[
       Style["z", 15, Bold],
       Background -> White,
  ...
  rightPlot =
   Graphics[
    {
     {LightBlue, Opacity[0.5], EdgeForm[{Thick, Blue, Dashed}], Rectangle[{3, -3}, {9, 3}]},
     {GrayLevel[0.45], Dashed, Line[{{Re[w], 0}, wPoint}], Line[{{0, Im[w]}, wPoint}]},
     {Darker[Green], Thick, Line[{{6, 0}, wPoint}]},
     {Red, AbsolutePointSize[11], Point[wPoint]},
     Text[
      Framed[
       Style["w", 15, Bold],
       Background -> White,
  ...
  Column[
   {
    Style["Problem 2(a): dilation under w = 3 z", 22, Bold],
    GraphicsRow[{leftPlot, rightPlot}, Spacings -> 30],
    Style[
     Row[{
       "z = ", NumberForm[x, {3, 2}], " + ", NumberForm[y, {3, 2}], " i",
       "    \[LongRightArrow]    w = ", NumberForm[Re[w], {4, 2}], " + ", NumberForm[Im[w], {4, 2}], " i"
       }],
     15
     ]
 ...
 {{x, 2.2, "x"}, 1, 3, Appearance -> "Labeled"},
 {{y, 0.3, "y"}, -1, 1, Appearance -> "Labeled"},
 TrackedSymbols :> {x, y}
]
```
...
Manipulate[
 Module[
  ...
  rightPlot =
   Graphics[
    {
     {LightBlue, Opacity[0.5], EdgeForm[{Thick, Blue, Dashed}], Rectangle[{-2, 2}, {2, 6}]},
     {GrayLevel[0.45], Dashed, Line[{{Re[w], 0}, wPoint}], Line[{{0, Im[w]}, wPoint}]},
     {Darker[Green], Thick, Line[{{0, 4}, wPoint}]},
     {Red, AbsolutePointSize[11], Point[wPoint]},
     Text[
      Framed[
       Style["w", 15, Bold],
    ...
    Axes -> True,
    GridLines -> Automatic,
    PlotRange -> {{-2.8, 2.8}, {-0.5, 6.8}},
    AspectRatio -> Automatic,
    ImageSize -> 520,
    PlotLabel -> Style["w-plane: g[S]", 18],
    AxesLabel -> {"u", "v"}
    ];
  
  Column[
   {
    Style["Problem 2(b): dilation and rotation under w = 2 i z", 22, Bold],
    GraphicsRow[{leftPlot, rightPlot}, Spacings -> 30],
    Style[
     Row[{
       "z = ", NumberForm[x, {3, 2}], " + ", NumberForm[y, {3, 2}], " i",
...
Manipulate[
 Module[
  ...
  leftPlot =
   Graphics[
    {
     {LightBlue, Opacity[0.5], EdgeForm[{Thick, Blue, Dashed}], Disk[{0, 0}, 1, {0, Pi/2}]},
     {White, Disk[{0, 0}, 0.06]},
     {GrayLevel[0.45], Dashed, Line[{{zPoint[[1]], 0}, zPoint}], Line[{{0, zPoint[[2]]}, zPoint}]},
     {Darker[Green], Thick, Line[{{0, 0}, zPoint}]},
     {Red, AbsolutePointSize[11], Point[zPoint]},
     Text[Framed[Style["z", 15, Bold], Background -> White, FrameStyle -> None, FrameMargins -> Tiny], zPoint + {0.08, 0.08}]
     },
    Axes -> True,
    GridLines -> Automatic,
    PlotRange -> {{-0.2, 1.3}, {-0.2, 1.3}},
    AspectRatio -> 1,
    ImageSize -> 390,
    PlotLabel -> Style["z-plane: S", 18],
    AxesLabel -> {"x", "y"}
  ...
  rightPlot =
   Graphics[
    {
     {LightBlue, Opacity[0.5], EdgeForm[{Thick, Blue, Dashed}], Annulus[{0, 0}, {1, 3}, {-Pi/2, 0}]},
     {GrayLevel[0.45], Dashed, Line[{{wPoint[[1]], 0}, wPoint}], Line[{{0, wPoint[[2]]}, wPoint}]},
     {Darker[Green], Thick, Line[{{0, 0}, wPoint}]},
     {Red, AbsolutePointSize[11], Point[wPoint]},
     Text[Framed[Style["w", 15, Bold], Background -> White, FrameStyle -> None, FrameMargins -> Tiny], wPoint + {0.1, 0.08}]
     },
    Axes -> True,
    GridLines -> Automatic,
    PlotRange -> {{-0.2, 3.2}, {-3.2, 0.2}},
    AspectRatio -> 1,
    ImageSize -> 470,
    PlotLabel -> Style["w-plane: f[S] (shown to |w| \[LessEqual] 3)", 18],
    AxesLabel -> {"u", "v"}
    ];
  
  Column[
   {
    Style["Problem 3(a): inversion under w = 1/z", 22, Bold],
    GraphicsRow[{leftPlot, rightPlot}, Spacings -> 25],
    Style[
     Row[{
       "z = ", NumberForm[Re[z], {3, 2}], " + ", NumberForm[Im[z], {3, 2}], " i",
       "    \[LongRightArrow]    w = ", NumberForm[Re[w], {4, 2}], " + ", NumberForm[Im[w], {4, 2}], " i"
 ...
 {{r, 0.7, "r"}, 0.12, 0.98, Appearance -> "Labeled"},
 {{\[Theta], Pi/4, "\[Theta]"}, 0, Pi/2, Appearance -> "Labeled"},
 TrackedSymbols :> {r, \[Theta]}
]
```
...
Manipulate[
 Module[
  ...
  leftPlot =
   Graphics[
    {
     {LightBlue, Opacity[0.5], EdgeForm[{Thick, Blue, Dashed}], Annulus[{0, 0}, {2, 6}, {0, Pi}]},
     {GrayLevel[0.45], Dashed, Line[{{zPoint[[1]], 0}, zPoint}], Line[{{0, zPoint[[2]]}, zPoint}]},
     {Darker[Green], Thick, Line[{{0, 0}, zPoint}]},
     {Red, AbsolutePointSize[11], Point[zPoint]},
     Text[Framed[Style["z", 15, Bold], Background -> White, FrameStyle -> None, FrameMargins -> Tiny], zPoint + {0.12, 0.12}]
     },
    Axes -> True,
    GridLines -> Automatic,
    PlotRange -> {{-6.2, 6.2}, {-0.3, 6.2}},
    AspectRatio -> 1/1.9,
    ImageSize -> 420,
    PlotLabel -> Style["z-plane: S (shown to |z| \[LessEqual] 6)", 18],
    AxesLabel -> {"x", "y"}
    ];
  ...
  rightPlot =
   Graphics[
    {
     {LightBlue, Opacity[0.5], EdgeForm[{Thick, Blue, Dashed}], Disk[{0, 0}, 1/2, {-Pi, 0}]},
     {White, Disk[{0, 0}, 0.03]},
     {GrayLevel[0.45], Dashed, Line[{{wPoint[[1]], 0}, wPoint}], Line[{{0, wPoint[[2]]}, wPoint}]},
     {Darker[Green], Thick, Line[{{0, 0}, wPoint}]},
     {Red, AbsolutePointSize[11], Point[wPoint]},
     Text[Framed[Style["w", 15, Bold], Background -> White, FrameStyle -> None, FrameMargins -> Tiny], wPoint + {0.04, 0.05}]
     },
    Axes -> True,
    GridLines -> Automatic,
  ...
  Column[
   {
    Style["Problem 3(b): inversion under w = 1/z", 22, Bold],
    GraphicsRow[{leftPlot, rightPlot}, Spacings -> 25],
    Style[
     Row[{
       "z = ", NumberForm[Re[z], {4, 2}], " + ", NumberForm[Im[z], {4, 2}], " i",
       "    \[LongRightArrow]    w = ", NumberForm[Re[w], {5, 3}], " + ", NumberForm[Im[w], {5, 3}], " i"
       }],
     15
     ]
    }
 ...
 {{r, 3.2, "r"}, 2, 6, Appearance -> "Labeled"},
 {{\[Theta], Pi/2, "\[Theta]"}, 0, Pi, Appearance -> "Labeled"},
 TrackedSymbols :> {r, \[Theta]}
]
```
...
Manipulate[
 Module[
  ...
  leftBoundary[v_] := 1 - v^2/4;
  rightBoundary[v_] := 4 - v^2/16;
  traceCurve = Table[{x0^2 - t^2, 2 x0 t}, {t, -4, 4, 0.05}];
  
  leftPlot =
   Graphics[
    {
     {LightBlue, Opacity[0.45], Rectangle[{1, -4}, {2, 4}]},
     {Blue, Dashed, Thick, Line[{{1, -4}, {1, 4}}], Line[{{2, -4}, {2, 4}}]},
     {GrayLevel[0.45], Dashed, Line[{{x0, 0}, zPoint}], Line[{{0, y0}, zPoint}]},
     {Darker[Green], Thick, Line[{{x0, -4}, {x0, 4}}]},
     {Red, AbsolutePointSize[11], Point[zPoint]},
     Text[Framed[Style["z", 15, Bold], Background -> White, FrameStyle -> None, FrameMargins -> Tiny], zPoint + {0.08, 0.18}]
     },
    Axes -> True,
    GridLines -> Automatic,
    PlotRange -> {{-0.2, 3}, {-4.2, 4.2}},
    AspectRatio -> 1,
    ImageSize -> 380,
    PlotLabel -> Style["z-plane: S", 18],
    AxesLabel -> {"x", "y"}
  ...
  rightPlot =
   Show[
    RegionPlot[
     leftBoundary[v] <= u <= rightBoundary[v] && -8 <= v <= 8,
     {u, -16, 5},
     {v, -8, 8},
     PlotStyle -> Directive[LightBlue, Opacity[0.45]],
     BoundaryStyle -> None,
     Axes -> True,
     GridLines -> Automatic,
     PlotRange -> {{-16, 5}, {-8, 8}},
    ...
    Graphics[
     {
      {Blue, Dashed, Thick, Line[Table[{leftBoundary[t], t}, {t, -8, 8, 0.05}]]},
      {Blue, Dashed, Thick, Line[Table[{rightBoundary[t], t}, {t, -8, 8, 0.05}]]},
      {Darker[Green], Thick, Line[traceCurve]},
      {GrayLevel[0.45], Dashed, Line[{{Re[w], 0}, wPoint}], Line[{{0, Im[w]}, wPoint}]},
      {Red, AbsolutePointSize[11], Point[wPoint]},
      Text[Framed[Style["w", 15, Bold], Background -> White, FrameStyle -> None, FrameMargins -> Tiny], wPoint + {0.3, 0.28}]
      }
     ]
    ];
  ...
  Column[
   {
    Style["Exercise 4: mapping the strip under w = z^2", 22, Bold],
    GraphicsRow[{leftPlot, rightPlot}, Spacings -> 25],
    Style[
     Row[{
       "z = ", NumberForm[Re[z], {3, 2}], " + ", NumberForm[Im[z], {4, 2}], " i",
       "    \[LongRightArrow]    w = ", NumberForm[Re[w], {6, 2}], " + ", NumberForm[Im[w], {6, 2}], " i"
       }],
     15
     ]
    }
 ...
 {{x0, 1.4, Subscript["x", 0]}, 1, 2, Appearance -> "Labeled"},
 {{y0, 1.0, Subscript["y", 0]}, -4, 4, Appearance -> "Labeled"},
 TrackedSymbols :> {x0, y0}
]
```
...
Manipulate[
 Module[
  ...
  leftPlot =
   Graphics[
    {
     {LightBlue, Opacity[0.45], EdgeForm[{Thick, Blue, Dashed}], Disk[{0, 0}, 3/2, {0, Pi/4}]},
     {GrayLevel[0.45], Dashed, Line[{{zPoint[[1]], 0}, zPoint}], Line[{{0, zPoint[[2]]}, zPoint}]},
     {Darker[Green], Thick, Line[{{0, 0}, zPoint}]},
     {Red, AbsolutePointSize[11], Point[zPoint]},
     Text[
      Framed[Style["z", 15, Bold], Background -> White, FrameStyle -> None, FrameMargins -> Tiny],
      zPoint + {0.08, 0.08}
      ]
     },
    Axes -> True,
    GridLines -> Automatic,
    PlotRange -> {{-0.2, 1.7}, {-0.2, 1.7}},
    AspectRatio -> 1,
    ImageSize -> 390,
    PlotLabel -> Style["z-plane: S", 18],
    AxesLabel -> {"x", "y"}
  ...
  rightPlot =
   Graphics[
    {
     {LightBlue, Opacity[0.45], EdgeForm[{Thick, Blue, Dashed}], Disk[{0, 0}, 27/8, {0, 3 Pi/4}]},
     {GrayLevel[0.45], Dashed, Line[{{wPoint[[1]], 0}, wPoint}], Line[{{0, wPoint[[2]]}, wPoint}]},
     {Darker[Green], Thick, Line[{{0, 0}, wPoint}]},
     {Red, AbsolutePointSize[11], Point[wPoint]},
     Text[
      Framed[Style["w", 15, Bold], Background -> White, FrameStyle -> None, FrameMargins -> Tiny],
      wPoint + {0.12, 0.12}
      ]
     },
    Axes -> True,
    GridLines -> Automatic,
    PlotRange -> {{-2.6, 3.6}, {-0.2, 6.0}},
    AspectRatio -> 1,
    ImageSize -> 470,
    PlotLabel -> Style["w-plane: f[S]", 18],
    AxesLabel -> {"u", "v"}
  ...
  Column[
   {
    Style["Exercise 5: mapping a sector under w = z^3", 22, Bold],
    GraphicsRow[{leftPlot, rightPlot}, Spacings -> 25],
    Style[
     Row[{
       "z = ", NumberForm[Re[z], {4, 2}], " + ", NumberForm[Im[z], {4, 2}], " i",
       "    \[LongRightArrow]    w = ", NumberForm[Re[w], {5, 2}], " + ", NumberForm[Im[w], {5, 2}], " i"
       }],
     15
     ]
    }
 ...
 {{r, 1.0, "r"}, 0, 3/2, Appearance -> "Labeled"},
 {{\[Theta], Pi/8, "\[Theta]"}, 0, Pi/4, Appearance -> "Labeled"},
 TrackedSymbols :> {r, \[Theta]}
]
```
...
Manipulate[
 Module[
  ...
  segZ = Table[t {Cos[theta0], Sin[theta0]}, {t, 0, 1, 1/120}];
  segW = Table[4 t {Cos[theta0], Sin[theta0]}, {t, 0, 1, 1/120}];
  ...
  rightPlot =
   Graphics[
    {
     {LightBlue, Opacity[0.5], EdgeForm[{Thick, Blue, Dashed}], Disk[{0, 0}, 4]},
     If[showSegment, {Blue, Thick, Line[segW]}, {}],
     {Red, PointSize[0.025], Point[wPoint]},
     Text[Style["w", 16, Bold], wPoint + {0.15, 0.15}]
     },
    Axes -> True,
    GridLines -> Automatic,
    PlotRange -> {{-5, 5}, {-5, 5}},
  ...
  Column[
   {
    Style["Problem 21: interactive map under w = 4 z", 22, Bold],
    GraphicsRow[{leftPlot, rightPlot}, Spacings -> 30],
    Style[
     Row[{
       "z = ", NumberForm[x, {3, 2}], " + ", NumberForm[y, {3, 2}], " i",
 ...
 {{x, 0.6, "x"}, -0.95, 0.95, Appearance -> "Labeled"},
 {{y, 0., "y"}, Dynamic[-Sqrt[Max[0, 0.95^2 - x^2]]], Dynamic[Sqrt[Max[0, 0.95^2 - x^2]]], Appearance -> "Labeled"},
 Delimiter,
 {{showSegment, True, "show image of radial segment Arg z = θ0"}, {True, False}},
 {{theta0, Pi/4, "θ0"}, 0, 2 Pi, Appearance -> "Labeled"},
 TrackedSymbols :> {x, y, showSegment, theta0}
]
```
...
Manipulate[
 Module[
  ...
  segZ = Table[{t, y0}, {t, 0, 4, 4/160}];
  segW = Table[{t, y0 + 1}, {t, 0, 4, 4/160}];
  ...
  leftPlot =
   Show[
    ...
    Graphics[
     {
      {Blue, Dashed, Thick, Line[{{0, -3}, {0, 3.5}}]},
      If[showSegment, {Blue, Thick, Line[segZ]}, {}],
      {Red, PointSize[0.025], Point[zPoint]},
      Text[Style["z", 16, Bold], zPoint + {0.08, 0.08}]
      }
  ...
  rightPlot =
   Show[
    ...
    Graphics[
     {
      {Blue, Dashed, Thick, Line[{{0, -3}, {0, 4.5}}]},
      If[showSegment, {Blue, Thick, Line[segW]}, {}],
      {Red, PointSize[0.025], Point[wPoint]},
      Text[Style["w", 16, Bold], wPoint + {0.08, 0.08}]
      }
  ...
  Column[
   {
    Style["Problem 22: interactive map under w = z + i", 22, Bold],
    GraphicsRow[{leftPlot, rightPlot}, Spacings -> 30],
    Style[
     Row[{
       "z = ", NumberForm[x, {3, 2}], " + ", NumberForm[y, {3, 2}], " i",
 ...
 {{x, 1., "x"}, 0.1, 3.5, Appearance -> "Labeled"},
 {{y, 0., "y"}, -2.8, 3., Appearance -> "Labeled"},
 Delimiter,
 {{showSegment, True, "show image of horizontal segment y = y0"}, {True, False}},
 {{y0, 0.5, "y0"}, -2.8, 3., Appearance -> "Labeled"},
 TrackedSymbols :> {x, y, showSegment, y0}
]
```
...
Manipulate[
 Module[
  ...
  segZ = Table[{x0, t}, {t, 0, 4, 4/160}];
  segW = Table[{-x0, 2 - t}, {t, 0, 4, 4/160}];
  ...
  leftPlot =
   Show[
    ...
    Graphics[
     {
      {Blue, Dashed, Thick, Line[{{0, 0}, {4, 0}}]},
      {Blue, Dashed, Thick, Line[{{0, 0}, {0, 4}}]},
      If[showSegment, {Blue, Thick, Line[segZ]}, {}],
      {Red, PointSize[0.025], Point[zPoint]},
      Text[Style["z", 16, Bold], zPoint + {0.08, 0.08}]
      }
  ...
  rightPlot =
   Show[
    ...
    Graphics[
     {
      {Blue, Dashed, Thick, Line[{{0, -2}, {0, 4}}]},
      {Blue, Dashed, Thick, Line[{{-4.5, 2}, {0.8, 2}}]},
      If[showSegment, {Blue, Thick, Line[segW]}, {}],
      {Red, PointSize[0.025], Point[wPoint]},
      Text[Style["w", 16, Bold], wPoint + {0.08, 0.08}]
      }
  ...
  Column[
   {
    Style["Problem 23: interactive map under w = -z + 2 i", 22, Bold],
    GraphicsRow[{leftPlot, rightPlot}, Spacings -> 30],
    Style[
     Row[{
       "z = ", NumberForm[x, {3, 2}], " + ", NumberForm[y, {3, 2}], " i",
 ...
 {{x, 1., "x"}, 0.1, 3.5, Appearance -> "Labeled"},
 {{y, 1., "y"}, 0.1, 3.5, Appearance -> "Labeled"},
 Delimiter,
 {{showSegment, True, "show image of vertical segment x = x0"}, {True, False}},
 {{x0, 1.2, "x0"}, 0.1, 3.5, Appearance -> "Labeled"},
...
Manipulate[
 Module[
  ...
  segZ = Table[t {Cos[theta0], Sin[theta0]}, {t, 0, 2, 2/120}];
  segW = Table[{2, 0} + t {Cos[theta0 + Pi/2], Sin[theta0 + Pi/2]}, {t, 0, 2, 2/120}];
  
  leftPlot =
   Graphics[
    {
     {LightBlue, Opacity[0.5], EdgeForm[{Thick, Blue}], Disk[{0, 0}, 2, {0, Pi/2}]},
     If[showSegment, {Blue, Thick, Line[segZ]}, {}],
     {Red, PointSize[0.025], Point[zPoint]},
     Text[Style["z", 16, Bold], zPoint + {0.08, 0.08}]
     },
  ...
  rightPlot =
   Graphics[
    {
     {LightBlue, Opacity[0.5], EdgeForm[{Thick, Blue}], Disk[{2, 0}, 2, {Pi/2, Pi}]},
     If[showSegment, {Blue, Thick, Line[segW]}, {}],
     {Red, PointSize[0.025], Point[wPoint]},
     Text[Style["w", 16, Bold], wPoint + {0.08, 0.08}]
     },
  ...
  Column[
   {
    Style["Problem 24: interactive map under w = i z + 2", 22, Bold],
    GraphicsRow[{leftPlot, rightPlot}, Spacings -> 30],
    Style[
     Row[{
       "z = ", NumberForm[Re[z], {3, 2}], " + ", NumberForm[Im[z], {3, 2}], " i",
 ...
 {{r, 1.4, "r"}, 0, 2, Appearance -> "Labeled"},
 {{\[Theta], Pi/4, "θ"}, 0, Pi/2, Appearance -> "Labeled"},
 Delimiter,
 {{showSegment, True, "show image of radial segment θ = θ0"}, {True, False}},
 {{theta0, Pi/6, "θ0"}, 0, Pi/2, Appearance -> "Labeled"},
 TrackedSymbols :> {r, \[Theta], showSegment, theta0}
]
```
...
Manipulate[
 Module[
  ...
  segZ = Table[r0 {Cos[t], Sin[t]}, {t, 0, 2 Pi, 2 Pi/180}];
  segW = Table[(1/r0) {Cos[t], Sin[t]}, {t, 0, 2 Pi, 2 Pi/180}];
  
  leftPlot =
   Graphics[
    {
     {LightBlue, Opacity[0.5], EdgeForm[{Thick, Blue}], Disk[{0, 0}, 1]},
     {White, EdgeForm[{Thick, Blue}], Disk[{0, 0}, 0.06]},
     If[showSegment, {Blue, Thick, Line[segZ]}, {}],
     {Red, PointSize[0.025], Point[zPoint]},
     Text[Style["z", 16, Bold], zPoint + {0.05, 0.05}]
     },
    Axes -> True,
    GridLines -> Automatic,
    PlotRange -> {{-1.4, 1.4}, {-1.4, 1.4}},
  ...
  Column[
   {
    Style["Problem 31: interactive map under w = 1/z", 22, Bold],
    GraphicsRow[{leftPlot, rightPlot}, Spacings -> 30],
    Style[
     Row[{
       "z = ", NumberForm[Re[z], {3, 2}], " + ", NumberForm[Im[z], {3, 2}], " i",
 ...
 {{r, 0.8, "r"}, 0.15, 1, Appearance -> "Labeled"},
 {{\[Theta], Pi/4, "θ"}, 0, 2 Pi, Appearance -> "Labeled"},
 Delimiter,
 {{showSegment, True, "show image of circle |z| = r0"}, {True, False}},
 {{r0, 0.6, "r0"}, 0.15, 1, Appearance -> "Labeled"},
 TrackedSymbols :> {r, \[Theta], showSegment, r0}
]
```
...
Manipulate[
 Module[
   ...
   Graphics[
    {
     ...
     If[showSegment, {Blue, Thick, Line[segW]}, {}],
     {Red, PointSize[0.025], Point[wPoint]},
     Text[Style["w", 16, Bold], wPoint + {0.05, 0.05}]
     },
    Axes -> True,
    GridLines -> Automatic,
    PlotRange -> {{-1.4, 1.4}, {-1.4, 1.4}},
  ...
  Column[
   {
    Style["Problem 32: interactive map under w = 1/z", 22, Bold],
    GraphicsRow[{leftPlot, rightPlot}, Spacings -> 30],
    Style[
     Row[{
       "z = ", NumberForm[Re[z], {3, 2}], " + ", NumberForm[Im[z], {3, 2}], " i",
 ...
 {{r, 2., "r"}, 1, 3.2, Appearance -> "Labeled"},
 {{\[Theta], 2 Pi/3, "θ"}, 0, 2 Pi, Appearance -> "Labeled"},
 Delimiter,
 {{showSegment, True, "show image of circle |z| = r0"}, {True, False}},
 {{r0, 1.8, "r0"}, 1, 3.2, Appearance -> "Labeled"},
 TrackedSymbols :> {r, \[Theta], showSegment, r0}
]
```
...
Manipulate[
 Module[
  ...
  segZ = Table[r0 {Cos[t], Sin[t]}, {t, Pi/3, 2 Pi/3, (Pi/3)/140}];
  segW = Table[(1/r0) {Cos[-t], Sin[-t]}, {t, Pi/3, 2 Pi/3, (Pi/3)/140}];
  
  leftPlot =
   Graphics[
    {
     {LightBlue, Opacity[0.5], EdgeForm[{Thick, Blue}], Disk[{0, 0}, 3, {Pi/3, 2 Pi/3}]},
     {White, EdgeForm[None], Disk[{0, 0}, 0.06]},
     If[showSegment, {Blue, Thick, Line[segZ]}, {}],
     {Red, PointSize[0.025], Point[zPoint]},
     Text[Style["z", 16, Bold], zPoint + {0.06, 0.06}]
     },
    Axes -> True,
    GridLines -> Automatic,
    PlotRange -> {{-3.2, 3.2}, {-1.2, 3.2}},
    AspectRatio -> 1,
    ImageSize -> 420,
    PlotLabel -> Style["z-plane: S", 18],
    AxesLabel -> {"x", "y"}
  ...
  rightPlot =
   Show[
    RegionPlot[
     u^2 + v^2 >= (1/3)^2 && -2 Pi/3 <= Arg[u + I v] <= -Pi/3,
     {u, -2.2, 2.2}, {v, -2.2, 0.8},
     PlotStyle -> Directive[LightBlue, Opacity[0.5]],
     BoundaryStyle -> None,
     Axes -> True,
     GridLines -> Automatic,
     PlotRange -> {{-2.2, 2.2}, {-2.2, 0.8}},
     AspectRatio -> 1,
     ImageSize -> 520,
     PlotLabel -> Style["w-plane: f[S]", 18],
     AxesLabel -> {"u", "v"}
    ...
    Graphics[
     {
      {Blue, Thick, Circle[{0, 0}, 1/3]},
      {Blue, Thick, Line[{{0, 0}, 2.2 {Cos[-Pi/3], Sin[-Pi/3]}}]},
      {Blue, Thick, Line[{{0, 0}, 2.2 {Cos[-2 Pi/3], Sin[-2 Pi/3]}}]},
      If[showSegment, {Blue, Thick, Line[segW]}, {}],
      {Red, PointSize[0.025], Point[wPoint]},
      Text[Style["w", 16, Bold], wPoint + {0.06, 0.06}]
      }
     ]
    ];
  ...
  Column[
   {
    Style["Problem 33: interactive map under w = 1/z", 22, Bold],
    GraphicsRow[{leftPlot, rightPlot}, Spacings -> 30],
    Style[
     Row[{
       "z = ", NumberForm[Re[z], {3, 2}], " + ", NumberForm[Im[z], {3, 2}], " i",
 ...
 {{r, 1.5, "r"}, 0.2, 3, Appearance -> "Labeled"},
 {{\[Theta], 5 Pi/12, "θ"}, Pi/3, 2 Pi/3, Appearance -> "Labeled"},
 Delimiter,
 {{showSegment, True, "show image of circular arc |z| = r0"}, {True, False}},
 {{r0, 2., "r0"}, 0.25, 3, Appearance -> "Labeled"},
 TrackedSymbols :> {r, \[Theta], showSegment, r0}
]
```
...
Manipulate[
 Module[
  ...
  rayMax[ang_] := Min[
    If[Cos[ang] > 10^-6, plotEdge/Cos[ang], Infinity],
    If[Sin[ang] > 10^-6, plotEdge/Sin[ang], Infinity]
    ];
  ...
  segZ = Table[
    t {Cos[theta0], Sin[theta0]},
    {t, holeRadius, rayMax[theta0], (rayMax[theta0] - holeRadius)/150}
    ];
  segW = Table[
    t {Cos[theta0], -Sin[theta0]},
    {t, holeRadius, rayMax[theta0], (rayMax[theta0] - holeRadius)/150}
    ...
    Graphics[
     {
      ...
      If[showSegment, {Blue, Thick, Line[segZ]}, {}],
      {Red, PointSize[0.025], Point[zPoint]},
      Text[Style["z", 16, Bold], zPoint + {0.07, 0.07}]
      }
     ]
    ];
    ...
    Graphics[
     {
      ...
      If[showSegment, {Blue, Thick, Line[segW]}, {}],
      {Red, PointSize[0.025], Point[wPoint]},
      Text[Style["w", 16, Bold], wPoint + {0.07, 0.07}]
      }
     ]
    ];
  ...
  Column[
   {
    Style["Problem 34: interactive map under w = 1/z", 22, Bold],
    GraphicsRow[{leftPlot, rightPlot}, Spacings -> 30],
    Style[
     Row[{
       "z = ", NumberForm[Re[z], {3, 2}], " + ", NumberForm[Im[z], {3, 2}], " i",
 ...
 {{r, 1.4, "r"}, 0.2, 3, Appearance -> "Labeled"},
 {{\[Theta], Pi/4, "θ"}, 0, Pi/2, Appearance -> "Labeled"},
 Delimiter,
 {{showSegment, True, "show image of ray Arg z = θ0"}, {True, False}},
 {{theta0, Pi/6, "θ0"}, 0, Pi/2, Appearance -> "Labeled"},
 TrackedSymbols :> {r, \[Theta], showSegment, theta0}
]
```
