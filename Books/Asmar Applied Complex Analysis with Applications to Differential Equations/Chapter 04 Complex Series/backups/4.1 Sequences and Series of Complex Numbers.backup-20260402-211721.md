...
(b) The first few terms of the sequence $\left\{\frac{e^{\operatorname{tn} \frac{\pi}{4}}}{n}\right\}_{n=1}^{\infty}$ are shown in _Figure 2_. The figure suggests that the sequence converges to $L \stackrel{n}{=} 0$. Let us prove this using the definition. Given $\epsilon>0$, we have
