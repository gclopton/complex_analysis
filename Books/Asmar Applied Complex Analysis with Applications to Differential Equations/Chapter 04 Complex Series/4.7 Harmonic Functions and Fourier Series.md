...
where the limit holds at all points $R e^{i \theta}$ where $f(\theta)$ is continuous (_Figure 1_). 



> [!figure] Figure 1
> 
> ![300](./images/5443c314-b89d-4dd1-b950-bb21550520a5-73_492_487_681_69.jpg)
> Figure 1 A Dirichlet problem on a disk with radius $R>0$ and center at the origin.




In Section 3.8, Theorem 3, we derived the **solution** in the form of an integral:
...
> [!lemma] Lemma 1 Series Form of the Poisson Kernel
...
> [!theorem] Theorem 1: Fourier Series Form of the Poisson Integral Formula
...
> where $a_{0}, a_{n}$, and $b_{n}$ are the Fourier coefficients of $f$, given by the following:
> 
> $$a_0=\frac{1}{2 \pi} \int_0^{2 \pi} f(\theta) d \theta; \tag{6}$$
> $$
> a_n=\frac{1}{\pi} \int_0^{2 \pi} f(\theta) \cos n \theta d \theta \quad(n=1,2, \ldots); \tag{7}
> $$
> 
> $$
> b_n=\frac{1}{\pi} \int_0^{2 \pi} f(\theta) \sin n \theta d \theta \quad(n=1,2, \ldots). \tag{8}
> $$
> 
> 
...
> [!exercise] Exercise 1 A steady-state problem in a disk
> 
...
> [!figure] Figure 2
> 
> ![300](./images/5443c314-b89d-4dd1-b950-bb21550520a5-75_555_464_1699_57.jpg)
...
> [!exercise] Exercise 2: Fourier Series of a Square Wave
> 
> 
> <span style="color:#ff0000; font-weight:bold">formulate exercise statement</span>


The boundary function in Example 1 is plotted in _Figure 3_. 


> [!figure] Figure 3
> 
> ![300](./images/5443c314-b89d-4dd1-b950-bb21550520a5-77_384_473_1214_68.jpg)
> Figure 3 The boundary function in Example 1, as a $2 \pi$ periodic function of $\theta$.



Setting $r=2$ in the **solution** (11) and using the fact that $\lim _{r \uparrow 2} u(r, \theta)=f(\theta)$, we would expect to get the Fourier series representation
...
To justify this representation, in _Figure 4_, we plotted $f(\theta)$ and several partial sums of the Fourier series
...
The Fourier series of $f$ converges pointwise to $f(\theta)$ at each point $\theta$ where $f$ is continuous. This is illustrated in _Figure 4_. 
...
> [!figure] Figure 4
> 
> ![300](./images/5443c314-b89d-4dd1-b950-bb21550520a5-78_575_1434_172_643.jpg)
...
At the points of discontinuity ( $\theta=m \pi, m=0, \pm 1, \pm 2, \ldots$ ), all terms $\sin (2 k+1) \theta$ are zero and so we know that the series converges to 50 . The graph of the Fourier series $50+\frac{200}{\pi} \sum_{k=0}^{\infty} \frac{\sin (2 k+1) \theta}{2 k+1}$ is shown in _Figure 5_. It agrees with the graph of the function, except at the points of discontinuity.



> [!figure] Figure 5
> 
> ![300](./images/5443c314-b89d-4dd1-b950-bb21550520a5-78_365_557_1127_105.jpg)
