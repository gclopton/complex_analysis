...
> [!theorem] Theorem 1: Cauchy's Residue Theorem
...
**proof** Take amall circles $C_{r_{j}}\left(z_{j}\right)(j=1,2, \ldots, n)$ that do not intersect each other and are contained in the interior of $C$ (_Figure 1_). 
...
Apply Cauchy's integral theoren for multiply connected regions (Theorem 6, Section 3.4) and get
...
> [!exercise] Exercise 1 An application of the residue theorem
> 
> Let $C$ be a simple closed positively oriented path such that $1,-i$, and $z$ ate in the interior of $C$ and -1 is in the exterior of $C$ (_Figure 2_). 
> 
> 
> 
> > [!figure] Figure 2
...
> [!proposition] Proposition 1: Residue at a Simple Monopole
> 
...
> [!theorem] Theorem 2: Residue at a Pole of Order $m$
...
> [!exercise] Exercise 2 Computing residues
> 
> Let $C$ be the simple closed path shown in _Figure 3_. 
> 
> 
> 
> 
...
> 
> 
> (a) Compute the residues of $f(z)=\frac{z^{2}}{\left(z^{2}+\pi^{2}\right)^{2} \sin z}$ at all the isolated singularities inside $C$. (b) Evaluate
> 
> $$
...
> [!exercise] Exercise 3 Residue at a second-order pole
> 
...
> [!exercise] Exercise 4 Residues of the cotangent
> 
...
> $$
> 
> where $C$ is the positively oriented rectangular path shown in _Figure 4_.
> 
> 
> > [!figure] Figure 4
> > 
...
> [!exercise] Exercise 5 Residue at 0 of an even function
> 
...
> [!exercise] Exercise 6 Multiplying series by a polynomial
> 
...
> [!exercise] Exercise 7 Using Cauchy products
> 
...
> [!exercise] Exercise 8
> In problems 1-12, find the residue of the given function at all its isolated singularities.
> 
> 1. $\frac{1+z}{z}$.
...
In problems 13-26, evaluate the given path integral. The path $R$ in problems 15 and 20 is shown in _Figure 5_.


> [!figure] Figure 5
> 
> ![300](./images/b1ad9866-c636-4d3b-85cb-e1f2bdb2e560-08_486_536_1349_108.jpg)
> Figure 5 The path $R$ for problems 15 and 20.
...
> 27. (a) Prove $\operatorname{Res}\left(f(z) g(z), z_0\right)=g\left(z_0\right) \operatorname{Res}\left(f(z), z_0\right)$..
> (b) Use your results from part a to prove (10).
...
> 34. Use problem 33 to compute Res $\left(e^{\frac{1}{z^{2}}} \sin \frac{1}{z}, 0\right)$.
...
> In problems $35-36, g$ and $h$ are analytic at $z_{0}$. You are asked to compute a formula for the residue of $f(z)=\frac{g(z)}{h(z)}$ at $z_{0}$ under given conditions.
...
> (a) Using the integral representation of $J_{0}$ from problem 35(a), Section 4.5, write
> 
> $$
