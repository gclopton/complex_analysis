...
and hence $\frac{1}{\left(z^{2}+1\right)\left(z^{2}+4\right)}$ has simple poles at $i$ and $2 i$ in the upper half-plane (_Figure 5_). The residues there are
